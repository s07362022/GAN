...
def generator_model():
    ...
    fc1 = Dense(input_dim=10, units=504*28*28)(inputs)
    fc1 = BatchNormalization()(fc1)
    fc1 = LeakyReLU(0.2)(fc1)
    fc1 =Dropout(0.25)(fc1)
    print(fc1.get_shape())
    # fc2 = Reshape((7, 7, 128), input_shape=(128*7*7,))(fc1)
    fc2 = Reshape((28, 28, 504*10), input_shape=(504*28*28,3))(fc1)
    fc2 =Dropout(0.2)(fc2)
...
def train(BATCH_SIZE, X_train):
    ...
    # d_optim = RMSprop(lr=0.00009) #0.004
    # g_optim = RMSprop(lr=0.0001)
    d_optim = Adam(lr=0.00009)
    ...
    for epoch in range(20):
        ...
        for index in range(n_iter):
            ...
            # noise = np.random.uniform(0, 1, size=(BATCH_SIZE, 10))  # ori
            noise =np.random.normal(0, 1, size=(BATCH_SIZE, 10,3))
...
def anomaly_detector(g=None, d=None):
    ...
    aInput = Input(shape=(10,3))
    gInput = Dense(3, trainable=True)(aInput) #10
...
def compute_anomaly_score(model, x, iterations=500, d=None):
    ...
    z = np.random.normal(0, 1, size=(1, 10,3))#,3))
